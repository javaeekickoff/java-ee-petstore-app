# Application - Petstore Java EE 8

* *Author* : [Antonio Goncalves](http://www.antoniogoncalves.org)
* *Level* : Intermediate
* *Technologies* : Java EE 8 (JPA 2.1, CDI 2.0, Bean Validation 1.1, EJB Lite 3.2, JSF 2.3, JAX-RS 2.0), Java SE 8 (because that's the minimum required by Java EE 8), Twitter Bootstrap (Bootstrap 3.x, JQuery 2.x, PrimeFaces 6.x)
* *Application Servers* : WildFly 10, WildFly 11
* *Summary* : A Petstore-like application using Java EE 8
...
* use Java EE 8 and just Java EE 8 : no external framework or dependency (except web frameworks or logging APIs)
...
If you want to use a different web interface, external frameworks, add some sexy alternative JVM language... feel free to fork the code. But the goal of this EE 8 Petstore is to remain simple and to stick to Java EE 8.
